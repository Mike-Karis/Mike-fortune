...
public class AppConfig {
    ...
    @Bean
    @Scope(BeanDefinition.SCOPE_PROTOTYPE)
    public HoroscopeService horoscopeService(ZodiacService zodiacService, FortuneCrudRepo fortuneCrudRepo){
        return new RandomHoroscopeService(fortuneCrudRepo, zodiacService);
    }
}
